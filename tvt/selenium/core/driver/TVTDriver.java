/**
 *  TVTWebDriver is for declaring and launching the browser with configuration required for TVT use.
...
import tvt.selenium.core.tool.WinRegistry;

public class TVTDriver{

	private String browserType;
	private WebDriver driver;
	private TVTProfile profile;
	private WebDebug debug;

	/**
	public TVTDriver(String browserType,String browserOption,String locale){
		profile = new TVTProfile(locale);
		initWebDebug();
		launchWebDriver(browserType,browserOption,locale);
	}
	**/
	public TVTDriver(String browserType,TVTProfile tvtProfile){
		profile = tvtProfile;
		initWebDebug();
		launchWebDriver(browserType,tvtProfile.getLocale());
	}
	
	public TVTDriver(WebDriver webdriver,TVTProfile tvtProfile){
		profile = tvtProfile;
		initWebDebug();
		driver = webdriver;
		//check browser type
	...
	public TVTProfile getProfile(){
		return profile;
	}
	
	public void debugPorilfeSettings(){
		debug.debugDriver("TVTProfile variable values:");
