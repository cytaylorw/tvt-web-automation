 ...
 * @author Taylor Wong
 */
package web.automation.core.browser.handle;
...
import web.automation.core.exception.handle.window.NoNewWindowException;
import web.automation.core.exception.handle.window.WindowHandlesIndexException;
import web.automation.core.exception.handle.window.WindowOutOfBoundException;
...
public class WebBrowserWindow {
	...
	private void delay(){
		browser.sleep(browser.getAutoProfile().getActionDelay());
	}
}
