...
import web.automation.core.element.action.ElementActionByAction;
import web.automation.core.element.action.ElementActionByDriver;
import web.automation.core.element.action.ElementActionByRobot;
import web.automation.core.element.action.ElementScroll;
import web.automation.core.tool.WebJavaScript;
import web.automation.core.widget.WebWidget;
...
public class BrowserElement{
	...
	/**
	 * Set the delay time with the action delay in AutoDriver.
	 * @return {@link BrowserElement}
	 */
	private BrowserElement enableDelay(){
		setDelay(browser.getAutoProfile().getActionDelay());
		return this;
	}
